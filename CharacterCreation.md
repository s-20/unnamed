...
1. **Concept**: Come up with a character concept in line with campaign parameters
2. **Aspects**: Put two ranks into [Aspects](Aspects.md) - either two ranks in a single Aspect, or one rank each in two different Aspects.
3. **Primary Characteristics**: Put 20 Ranks in [Traits](Traits.md), [Skills](Skills.md), and [Connections](Connections.md)
4. **Secondary Characteristics**: Determine [Special Abilities](SpecialAbilities.md), [Energy Pools](Energy.md), [Detiails](Details.md), [Tangles](Tangles.md), and [Wound Threshold](WoundThreshold.md)
5. **Stuff**: Outline your character‘s property, possessions, and other significant equipment
6. **Finishing Touches**
...
[Parameters](Parameters.md) involve general expectations, like scale, genre, setting, and so on. They also involve specific expectations of content, establishing safe topic matter, and getting everyone on the same page for the game.
...
- [Special Abilities](SpecialAbilities.md) — Typically superhuman abilities the character can exploit during the game, like superpowers, magical training, psychic ability, or cybernetic implants. Not all games will use Special Abilities.
...
### Step 2: Primary Characteristics (20 Ranks)

You get 20 Ranks to divide between [Traits](Traits.md), [Skills](Skills.md), and [Connections](Connections.md).
...
You get 20 ranks to put between Traits, Skills, and Connections. It‘s probably best to have at least three different entries for each Characteristic type, with at least five ranks in each category.

#### Extra Aspects

You can trade 2 Characteristic Ranks for 1 Aspect rank. You cannot have more than 2 ranks in an Aspect at the start, and you cannot start with more than three Aspects.

### Step 5: Secondary Characteristics
